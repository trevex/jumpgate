...
type Querier interface {
	...
	ClaimTargetIdentityMutation(ctx context.Context, arg ClaimTargetIdentityMutationParams) (TargetIdentityMutationRequest, error)
	CompleteProbeAttempt(ctx context.Context, arg CompleteProbeAttemptParams) (CompleteProbeAttemptRow, error)
	CompleteTargetIdentityMutation(ctx context.Context, arg CompleteTargetIdentityMutationParams) (TargetIdentityMutationRequest, error)
	...
	ListTargetIdentityObservationPage(ctx context.Context, arg ListTargetIdentityObservationPageParams) ([]TargetIdentityObservation, error)
	ListTargetIdentityObservations(ctx context.Context, assetID uuid.UUID) ([]TargetIdentityObservation, error)
	ListTargetProbeJobPage(ctx context.Context, arg ListTargetProbeJobPageParams) ([]TargetProbeJob, error)
