...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/trevex/jumpgate/warden/gen/jumpgate/health/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HealthServiceName = "jumpgate.health.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/jumpgate.health.v1.HealthService/Check"
)

// HealthServiceClient is a client for the jumpgate.health.v1.HealthService service.
type HealthServiceClient interface {
	Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error)
}

// NewHealthServiceClient constructs a client for the jumpgate.health.v1.HealthService service. By
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_jumpgate_health_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls jumpgate.health.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the jumpgate.health.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/jumpgate.health.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.CheckRequest]) (*connect.Response[v1.CheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("jumpgate.health.v1.HealthService.Check is not implemented"))
}
