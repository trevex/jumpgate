// Package record captures a structured session timeline (NDJSON) and uploads it
// to object storage. It is the pg-proxy/ssh-proxy analog for k8s-broker: it
// records API-request audit lines rather than statements or terminal bytes.
//
// ponytail: lifted from workers/pg-proxy/internal/record; unify into a shared
// module if a fourth recorder appears. 32 MiB single-PutObject ceiling — k8s audit
// lines are tiny.
package record
