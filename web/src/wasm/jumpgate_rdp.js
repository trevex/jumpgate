/* @ts-self-types="./jumpgate_rdp.d.ts" */
...
export class RdpSession {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        RdpSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_rdpsession_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    framebuffer_len() {
        const ret = wasm.rdpsession_framebuffer_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    framebuffer_ptr() {
        const ret = wasm.rdpsession_framebuffer_ptr(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    height() {
        const ret = wasm.rdpsession_height(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    constructor(header_bytes) {
        ...
        const ret = wasm.rdpsession_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        RdpSessionFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    process(action, payload) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.rdpsession_process(this.__wbg_ptr, action, ptr0, len0);
        if (ret[3]) {
    ...
    send_key(scancode, down) {
        const ret = wasm.rdpsession_send_key(this.__wbg_ptr, scancode, down);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
    ...
    send_mouse_button(button, down) {
        const ret = wasm.rdpsession_send_mouse_button(this.__wbg_ptr, button, down);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
     ...
     */
    send_mouse_move(x, y) {
        const ret = wasm.rdpsession_send_mouse_move(this.__wbg_ptr, x, y);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
     ...
     */
    send_wheel(delta) {
        const ret = wasm.rdpsession_send_wheel(this.__wbg_ptr, delta);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
     ...
     */
    terminated() {
        const ret = wasm.rdpsession_terminated(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {number}
     */
    width() {
        const ret = wasm.rdpsession_width(this.__wbg_ptr);
        return ret;
    }
}
if (Symbol.dispose) RdpSession.prototype[Symbol.dispose] = RdpSession.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./jumpgate_rdp_bg.js": import0,
    };
}

const RdpSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_rdpsession_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('jumpgate_rdp_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
